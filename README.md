...
| enumType              |                          `"stringUnion" \| "enum" \| "object" \| "none" \| "only"`                          |                              `"stringUnion"`                               | Controls how enums are generated. `"object"` will create an object and type like the Prisma client, `"enum"` will create TypeScript enums, `"stringUnion"` will create a string union type, and `"none"` will omit them from the output.           |
