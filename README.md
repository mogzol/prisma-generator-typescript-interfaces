...
| optionalDefaults                                                                                                                                   |               `boolean`               |                                  `false`                                   | Controls whether fields with a default value are made optional. If true, then fields with a `@default` attribute will use `?:` in their type definition.                                                      |
